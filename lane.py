...
# Description: Implementation of the Lane class  20210615-235429.png

filename = 'E:\\Uni\\Courses\\IUPUI\\Thesis\\SimulationEnv\\AirSim\\City\\Codes\\Images\\20210616-005555.png'
...
class Lane:
  ...
  def __init__(self, orig_frame):
    ...
    self.roi_points = np.float32([
      (500,450), # Top-left corner (274,184)
      (200, 720), # Bottom-left corner (0, 337)             
      (1080,720), # Bottom-right corner (575,337)
      (780,450) # Top-right corner (371,184)
    ])
         
    # The desired corner locations  of the region of interest
    # after we perform perspective transformation.
    # Assume image width of 600, padding == 150. (200)
    self.padding = int(0.30 * width) # padding from side of the image in pixels
  ...
  def perspective_transform(self, frame=None, plot=False):
    ...
    # Convert image to binary ???? 127
    (thresh, binary_warped) = cv2.threshold(
      self.warped_frame, 160, 255, cv2.THRESH_BINARY)           
...
def main(original_frame):
  ...
  FinalOffset = lane_obj.calculate_car_position(print_to_terminal=False)
