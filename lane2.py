...
class Lane:
  ...
  def __init__(self, orig_frame):
    ...
    self.roi_points = np.float32([
      (490,350), # Top-left corner (274,184)
      (0, 720), # Bottom-left corner (0, 337)             
      (1280,720), # Bottom-right corner (575,337)
      (790,350) # Top-right corner (371,184)
    ])
  ...
  def get_line_markings(self, frame=None):
    ...
    _, sxbinary = edge.threshold(hls[:, :, 1], thresh=(240, 255))
